...
def evaluate_results():
    ...
    report_lines = [
        "# Aman Testing Evaluation Report V2 - Advanced Sub-system Check",
        "",
    ...
    for chat_id, chat_data in data.items():
        ...
        for i, msg in enumerate(messages):
            if msg["role"] == "user":
                # Check metrics extracted from DB
                ...
                # Short content check (e.g. if the output safety stripped it but it wasn't caught in run_agent loop properly)
