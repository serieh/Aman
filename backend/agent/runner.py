...
async def run_agent(user_id: str, chat_id: str, user_message: str, model_preference: str = "2", mode: str = "normal", ai_msg_id: str | None = None, user_msg_id: str | None = None):
    ...
    with timed_operation("total_request", chat_id=chat_id, user_id=user_id):
        try:
            ...
            with timed_operation("save_response", chat_id=chat_id):
                await asyncio.to_thread(save_message, chat_id, role="assistant", content=assistant_content, safety_flag=assistant_flag, message_id=ai_msg_id)
