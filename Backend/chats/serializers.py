...
class MessageSerializer(serializers.ModelSerializer):
    class Meta:
        model  = Message
        fields = ["message_id", "role", "content", "creation_date", "emotional_state", "safety_flag", "persona_id"]
...
class ChatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Chat
        fields = ["chat_id", "title", "persona_id", "creation_date", "modify_date", "is_generating"]
...
class ChatDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Chat
        fields = ["chat_id", "title", "persona_id", "creation_date", "modify_date", "messages", "is_generating"]
...
class MessageRequestSerializer(serializers.Serializer):
    ...
    persona_id = serializers.CharField(max_length=50, required=False)